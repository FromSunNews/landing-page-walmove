            ...
            <div className="relative z-0">
              <p className="text-xl">
                <em className="relative">
                  ...
                  <TextGenerateEffect className="relative z-10 adaptive-text text-2xl font-bold" duration={0.2} words={"WALMOVE isn't a PC application; WALMOVE is your PC in the browser, where you can run anything without worrying about resources."} />
                </em>
              </p>
            </div>
            <BlurFade delay={0.5} inView>
              <footer className="mt-6 relative z-10">
                <div className="text-base font-semibold adaptive-text">Harry - Founder of
                  <LinkPreview isStatic url="https://can_thay_the.weminal.com/" imageSrc={theme === "dark" ? '/assets/about/product_preview_dark.png' : '/assets/about/product_preview_white.png'}>
                    {" "}
                    <a href="https://can_thay_the.weminal.com/" target="_blank" className="text-neutral-900 py-1 px-2 bg-yellow-400 rounded-full">Walmove</a>
                  </LinkPreview>
                </div>
              </footer>
            </BlurFade>
