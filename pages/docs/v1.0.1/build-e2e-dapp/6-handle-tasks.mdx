...
In the sixth and final chapter of the tutorial on [building an end-to-end dapp on Move](../build-e2e-dapp.mdx), you will add functionality to the app so the user interface is able to handle cases where an account has created a list.
...
You have now learned how to build a dapp on Move from end to end. Congratulations! Tell your friends. :-)